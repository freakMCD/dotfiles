    ...
    programs.firefox = {
      ...
      profiles.default = {
        ...
        userChrome = ''
          ...
          #trust-icon, #permissions-granted-icon, #translations-button-icon, #urlbar-searchmode-switcher, #back-button, #forward-button, #PanelUI-button, #tracking-protection-icon-container, #stop-button { display: none !important; }
