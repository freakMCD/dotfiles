...
reddit_videos = 'a[class*="thumbnail"],[href*="youtu"]'
...
bind = {
    ...
    lleader + "M": "hint videos spawn --detach mpv {hint-url} --profile=fastYT --force-window=yes",
    lleader + "f": "hint links spawn --detach mpv {hint-url} --force-window=yes",
    ## hints
    "e": "hint button",
	"i": "hint --first inputs",
    "I": "hint inputs",
