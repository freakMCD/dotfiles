{
  ...
  html2rss = {
    dependencies = ["addressable" "faraday" "faraday-follow_redirects" "kramdown" "mime-types" "nokogiri" "parallel" "puppeteer-ruby" "regexp_parser" "reverse_markdown" "rss" "sanitize" "thor" "tzinfo" "zeitwerk"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0w434yl07xsdsvlp9x8jm34j5zqjl899g3zygnvbjbr1fa19fz7r";
      type = "gem";
    };
    version = "0.17.0";
  };
